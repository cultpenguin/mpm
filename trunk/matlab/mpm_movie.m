% mpm_movie : show movie of MPM snapshot file.
%
% function MOVIE=mpm_movie(file,ix,iz,snap1,snap2p,dsnap,clip,p1,p2)
%
...
%
%
function [M,T]=mpm_movie(file,iix,iiz,n1,nsnap,skip,clip,p1,p2)
